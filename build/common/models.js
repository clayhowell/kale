...
var Currency;
(function(Currency) {
  Currency[(Currency['ADB'] = 0)] = 'ADB';
  Currency[(Currency['ETH'] = 1)] = 'ETH';
  Currency[(Currency['BTC'] = 2)] = 'BTC';
  Currency[(Currency['KCS'] = 3)] = 'ADB';
...
(function(ConnectivityStatus) {
  ...
  (ConnectivityStatus =
    exports.ConnectivityStatus || (exports.ConnectivityStatus = {}))
);
var Exchange;
(function(Exchange) {
  ...
  Exchange[(Exchange['Kucoin'] = 7)] = 'Kucoin';
...
(function(MarketDataFlag) {
  ...
  MarketDataFlag[(MarketDataFlag['PriceAndSizeChanged'] = 16)] =
    'PriceAndSizeChanged';
...
(function(AutoPositionMode) {
  ...
  (AutoPositionMode =
    exports.AutoPositionMode || (exports.AutoPositionMode = {}))
);
