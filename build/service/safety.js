...
class SafetyCalculator {
    constructor(_timeProvider, _repo, _broker, _qlParams, _publisher, _persister) {
        ...
        this.computeQtyLimit = () => {
            ...
            if (sellPq)
                sellPong /= sellPq;
            let orderTrades = (input, direction) => {
            ...
            let computeSafety = (t) => t.reduce((sum, t) => sum + t.quantity, 0) / this._qlParams.latest.size;
