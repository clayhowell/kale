...
let PositionController = ($scope: PositionScope, $log: ng.ILogService, subscriberFactory: Shared.SubscriberFactory, product: Shared.ProductState) => {
    ...
    let updatePosition = (position: Models.PositionReport) => {
...
export let positionDirective = 'positionDirective';
