...
//   let timeProvider: Backtest.BacktestTimeProvider;

//   beforeEach(() => {
//     let t0 = Moment.unix(1);
//     let t1 = Moment.unix(10);
...
//     let inputData: Array<Models.Market | Models.MarketTrade> = [
//       new Models.Market(
//         [new Models.MarketSide(10, 5)],
//         [new Models.MarketSide(20, 5)],
//         Moment.unix(1)
//       ),
//       new Models.Market(
//         [new Models.MarketSide(15, 5)],
//         [new Models.MarketSide(20, 5)],
//         Moment.unix(10)
//       )
//     ];

//     let timeProvider = new Backtest.BacktestTimeProvider(
//       Moment.unix(1),
//       Moment.unix(40)
//     );
//     let gateway = new Backtest.BacktestGateway(
//       inputData,
//       10,
//       5000,
//       timeProvider
